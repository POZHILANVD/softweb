...
<footer style="background-color:rgb(250, 0, 0);margin-top: 143; border: none;">
    <P style="color:#000000; ;"align="center">Designed and Devoloped by POZHILAN V D 23013442 </P>
</footer>
</html>
...
<html>
    ...
    <body>
        ...
        <img src="123.jpg" height="500" width="800">
    </center>
    </body>
    <footer style="background-color:rgb(247, 22, 22);margin-top: 64; border: none;">
        <P style="color:#070606; ;"align="center">Designed and Devoloped by POZHILAN V D 23013442 </P>
    </footer>
</html>
...
<style>
    ...
    .styled form {
        ...
        .styled [type="submit"]:hover {
            background-color:purple; /*background color on hover */
            color:#ee1d1d; /*text color on hover */
        }
        .styled [type="text"] {
            margin-left: 500px;
            transition: background-color 0.3s; 
...
<body>
    ...
    <div class="photos">
    <img src="POZHILAN (2).jpg" height="200" width="180">
    <img src="dhoni.jpeg" height="200" width="200">
    <img src="shahshi.png" height="200" width="200">
    <img src="virat.jpeg" height="200" width="200">
    <img src="anushka.jpg" height="200" width="200">
    <img src="rohit sharma.jpg" height="200" width="200">
    <img src="rohit sharma wife.jpg" height="200" width="200">
</div>
<div CLASS="names">
    <P> MR POZHILAN</P>    
...
<footer style="background-color:rgb(250, 0, 0);margin-top: 143; border: none;">
    <P style="color:#070807; ;"align="center">Designed and Devoloped by POZHILAN V D 23013442</P>
</footer>
</html>
...
<footer style="background-color:rgb(250, 0, 0); border: none;">
    <P style="color:#0a0808 ;"align="center">Designed and Devoloped by POZHILAN V D 23013442 </P>
</footer>
</html>
...
<body>
    ...
    <div class="company">
        <center>
        <h3 style="color: rgb(86, 163, 230);">COMPANY CONTACT DETAILS</h3>
       <p> <b >Address</b></p>
        <p >77,EAST ROAD ,</p>
        <p >T.NAGAR</p>
        <p >CHENNAI</p>
        <b >Email:</b>
        <p >pozhilan4321@gmail.com</p>
        <b >Phone</b>
        <p >9043693955</p>
    </center>
    </div>
</body>
<footer style="background-color:rgb(245, 52, 52);margin-top: 118px; border: none;">
    <P style="color:#151212 ;"align="center">Designed and Devoloped by POZHILAN V D 23013442 </P>
</footer>
</html>
